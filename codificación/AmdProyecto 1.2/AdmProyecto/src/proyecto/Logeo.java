...
public class Logeo extends JFrame {
	...
	public void iniciarSesion(){
		...
		con.conectar();
		try{
		PreparedStatement consulta=(PreparedStatement) con.conectar().prepareStatement("select *from usuario where usuario='"+textField.getText()+"' and contraseña ='"+passwordField.getText()+"'");	
